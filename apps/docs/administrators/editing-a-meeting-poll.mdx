---
title: "Edit a Meeting Poll"
description: "How to make changes to an existing meeting meeting poll."
---
...
To change these details of your meeting poll:
...
3.  Enter the new details of your meeting poll in to the form and click **Save**.
