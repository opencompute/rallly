...
title: Translations
icon: globe
description: Help translate Kinpal into your language
---

Kinpal is made available in different languages by volunteer translators.
...
<Card title="Email" icon="envelope" href="mailto:support@kinpal.com" />
<Card title="Discord" icon="discord" href="https://discord.gg/ZRZKqJf3tY" />
<Card
  title="Support chat"
  icon="comments"
