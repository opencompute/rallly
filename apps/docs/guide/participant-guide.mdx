...
description: "How to respond to a Kinpal meeting poll"
---
...
<AccordionGroup>
  <Accordion title="Why can't I edit my response?">
    Kinpal uses cookies in your browser to recognize you as the creator of a
...
In this case you should ask the administrator of the meeting poll to either delete your
