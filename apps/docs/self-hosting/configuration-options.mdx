...
description: Using environment variable to configure a self-hosted instance of Kinpal.
---
...
This page lists all environment variables supported by Kinpal.

### Base Configuration

These variables need to be configured for Kinpal to run and function properly.
...
These variables need to be configured to let Kinpal send out transactional emails.
