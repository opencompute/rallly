...
This page will guide you through the process of setting up a self-hosted instance of Kinpal using the Docker Compose configuration published in the [rallly-selfhosted](https://github.com/lukevella/rallly-selfhosted) repository on Github.
