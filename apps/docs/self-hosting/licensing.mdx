...
<Note>
Activation requires your server to reach `licensing.kinpal.com` over HTTPS. If activation fails and your server sits behind a corporate proxy or a firewall that inspects TLS, see [Corporate Networks](/self-hosting/corporate-networks).
</Note>
