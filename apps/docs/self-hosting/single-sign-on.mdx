...
If your identity provider supports OAuth 2.0 based authentication with OpenID Connect (OIDC), you can use it to authenticate users on your Kinpal instance.
...
<Info>
  Replace `{BASE_URL}` with the base URL of your Kinpal instance and add it to
