...
<Steps>
  <Step title="Review your results">
    ...
    <Frame>
      <img src="/images/workflow/finalize.png" alt="Finalize a meeting poll"/>
    </Frame>
  ...
  <Step title="Finalize">
    ...
    3. Close the meeting poll and prevent any further votes.

    The selected date will be displayed on your finalized meeting poll for everyone to see.

    <Frame>
      <img src="/images/workflow/finalized.png" alt="Finalized Meeting Poll"/>
    </Frame>
