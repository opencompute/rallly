            ...
            <Faq>
              ...
              >
                <Trans
                  ...
                  defaults="Yes. Anyone with the link can reply whether or not they use Kinpal, and whichever calendar system their own organization runs. There is no limit on how many members you invite, so trustees, co-opted members and advisers all respond the same way."
                />
              </FaqItem>
              <FaqItem
                question={
              ...
              >
                <Trans
                  ...
                  defaults="With <0>Kinpal Pro</0> you can add your own logo and colours and remove Kinpal attribution, so a poll you send to a board looks like it came from your organization. Everything else is free to use."
                  components={[
                    <Link
                      key="pricing"
...
export async function generateMetadata(props: {
  ...
  return {
    ...
    description: t("committeesMetaDescription", {
      ns: "home",
      defaultValue:
        "Kinpal is a free scheduling tool for committees, boards and trustees. Find a date that reaches quorum with one link. No account needed to respond.",
    }),
  };
}
