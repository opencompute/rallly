...
export async function generateMetadata(props: {
  ...
  return {
    ...
    description: t("eaMetaDescription", {
      ns: "home",
      defaultValue:
        "Kinpal is a free scheduling tool for executive assistants. Coordinate meetings across busy calendars and time zones with one link. No account needed to respond.",
    }),
  };
}
