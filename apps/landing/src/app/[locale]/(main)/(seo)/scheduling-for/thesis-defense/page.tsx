            ...
            <Faq>
              ...
              >
                <Trans
                  ...
                  defaults="Yes. Anyone with the link can reply whether or not they use Kinpal, and whichever system their own institution runs. That matters for externals, who are usually the hardest person to reach and the least likely to sign up for another tool."
                />
              </FaqItem>
              <FaqItem
                question={
              ...
              >
                <Trans
                  ...
                  defaults="With <0>Kinpal Pro</0> you can add your own logo and colours and remove Kinpal attribution, so a poll you send to an external examiner looks like it came from your department. Everything else is free to use."
                  components={[
                    <Link
                      key="pricing"
...
export async function generateMetadata(props: {
  ...
  return {
    ...
    description: t("thesisDefenseMetaDescription", {
      ns: "home",
      defaultValue:
        "Kinpal is a free scheduling tool for thesis defenses and vivas. Find a slot that suits every examiner across time zones with one link. No account needed.",
    }),
  };
}
