  ...
  return (
    <Marketing
      title={t("home:when2meetAlternativeMetaTitle", {
        defaultValue: "Best When2Meet Alternative: Kinpal",
      })}
      description={t("home:when2meetAlternativeMetaDescription", {
        defaultValue:
          "Find a better way to schedule meetings with Kinpal, the top free alternative to When2Meet. Easy to use and free.",
      })}
    >
      <MarketingHero
        ...
        description={t("home:when2meetAlternativeDescription", {
          defaultValue:
            "Create professional, ad-free meetings polls for free with Kinpal.",
        })}
        callToAction={
