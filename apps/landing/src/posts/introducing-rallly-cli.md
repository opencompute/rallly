...
If you're already running Kinpal from a hand edited `docker-compose.yml` or `config.env`, there's a step by step [migration guide](https://support.kinpal.com/self-hosting/migration) that walks you through upgrading to 4.10 and moving onto the CLI without losing data. The most important thing to carry over is your `SECRET_PASSWORD`, which encrypts sessions.

## Where to start

- **New install**: [Installation guide](https://support.kinpal.com/self-hosting/installation/docker)
- **Day to day operations**: [Management guide](https://support.kinpal.com/self-hosting/management)
- **Coming from an older setup**: [Migration guide](https://support.kinpal.com/self-hosting/migration)

The goal with this release was to make self-hosting feel like a product rather than a recipe. If you run into anything along the way, or have ideas for what should come next, I'd love to hear from you at [feedback@kinpal.com](mailto:feedback@kinpal.com).
