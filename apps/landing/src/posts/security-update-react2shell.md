...
**This announcement is only relevant to self-hosted Kinpal installations.** If you use Kinpal's hosted service at [kinpal.com](https://kinpal.com), you do not need to take any action. Our servers were patched within hours of the CVEs being announced, and there was no breach of our servers during that time.
